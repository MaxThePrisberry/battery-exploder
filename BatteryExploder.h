...
#define  PANEL_BTN_ALICAT_RUN_STOP        7       /* control type: command, callback function: ALICATRunStopCallback */
#define  PANEL_MFLOW_STATUS               8       /* control type: string, callback function: (none) */
#define  PANEL_NUM_SET_DISCHARGE_V        9       /* control type: numeric, callback function: (none) */
#define  PANEL_NUM_SET_CHARGE_I           10      /* control type: numeric, callback function: (none) */
#define  PANEL_NUM_SET_DISCHARGE_I        11      /* control type: numeric, callback function: (none) */
#define  PANEL_NUM_POWER                  12      /* control type: numeric, callback function: (none) */
...
#define  PANEL_TOGGLE_REMOTE_MODE         15      /* control type: binary, callback function: RemoteModeToggle */
#define  PANEL_BTN_TEST_QUEUE             16      /* control type: command, callback function: TestDeviceQueueCallback */
#define  PANEL_BTN_TEST_PSB               17      /* control type: command, callback function: TestPSBCallback */
#define  PANEL_STR_PSB_STATUS             18      /* control type: string, callback function: (none) */
#define  PANEL_BTN_TEST_TEMP_RAMP         19      /* control type: command, callback function: TestDTBRampSoakCallback */
#define  PANEL_BTN_TEST_ALICAT            20      /* control type: command, callback function: TestALICATCallback */
#define  PANEL_BTN_TEST_BIOLOGIC          21      /* control type: command, callback function: TestBiologicCallback */
#define  PANEL_STR_BIOLOGIC_STATUS        22      /* control type: string, callback function: (none) */
#define  PANEL_DEC_BAT_CONSTS             23      /* control type: deco, callback function: (none) */
#define  PANEL_BAT_CONSTS_LABEL_2         24      /* control type: textMsg, callback function: (none) */
#define  PANEL_BAT_CONSTS_LABEL_3         25      /* control type: textMsg, callback function: (none) */
#define  PANEL_LED_BIOLOGIC_STATUS        26      /* control type: LED, callback function: (none) */
#define  PANEL_LED_PSB_STATUS             27      /* control type: LED, callback function: (none) */
#define  PANEL_DEC_STATUS                 28      /* control type: deco, callback function: (none) */
#define  PANEL_CONTROL_LABEL              29      /* control type: textMsg, callback function: (none) */
#define  PANEL_STATUS_LABEL               30      /* control type: textMsg, callback function: (none) */
#define  PANEL_CMD_PROMPT_TEXTBOX         31      /* control type: textBox, callback function: (none) */
#define  PANEL_OUTPUT_TEXTBOX             32      /* control type: textBox, callback function: (none) */
#define  PANEL_EXPERIMENTS                33      /* control type: tab, callback function: (none) */
#define  PANEL_DEC_MANUAL_CONTROL         34      /* control type: deco, callback function: (none) */
#define  PANEL_GRAPH_2                    35      /* control type: graph, callback function: (none) */
#define  PANEL_DEC_GRAPHS                 36      /* control type: deco, callback function: (none) */
#define  PANEL_GRAPH_1                    37      /* control type: graph, callback function: (none) */
#define  PANEL_GRAPH_BIOLOGIC             38      /* control type: graph, callback function: (none) */
#define  PANEL_BAT_CONSTS_LABEL           39      /* control type: textMsg, callback function: (none) */
#define  PANEL_LED_DTB_2_STATUS           40      /* control type: LED, callback function: (none) */
#define  PANEL_LED_DTB_1_STATUS           41      /* control type: LED, callback function: (none) */
#define  PANEL_SPLITTER                   42      /* control type: splitter, callback function: (none) */
#define  PANEL_SPLITTER_3                 43      /* control type: splitter, callback function: (none) */
#define  PANEL_SPLITTER_2                 44      /* control type: splitter, callback function: (none) */
#define  PANEL_STR_DTB_2_STATUS           45      /* control type: string, callback function: (none) */
#define  PANEL_STR_DTB_1_STATUS           46      /* control type: string, callback function: (none) */
#define  PANEL_NUM_DTB_2_SETPOINT         47      /* control type: numeric, callback function: (none) */
#define  PANEL_NUM_ALICAT_SETPOINT        48      /* control type: numeric, callback function: (none) */
#define  PANEL_NUM_DTB_1_SETPOINT         49      /* control type: numeric, callback function: (none) */
#define  PANEL_NUM_DTB_2_TEMPERATURE      50      /* control type: scale, callback function: (none) */
#define  PANEL_NUM_DTB_1_TEMPERATURE      51      /* control type: scale, callback function: (none) */
...
int  CVICALLBACK ALICATRunStopCallback(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
