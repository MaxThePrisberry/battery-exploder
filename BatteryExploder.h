...
#define  PANEL_BTN_TEST_BIOLOGIC          18      /* control type: command, callback function: TestBiologicCallback */
#define  PANEL_STR_BIOLOGIC_STATUS        19      /* control type: string, callback function: (none) */
#define  PANEL_DEC_BAT_CONSTS             20      /* control type: deco, callback function: (none) */
#define  PANEL_BAT_CONSTS_LABEL_2         21      /* control type: textMsg, callback function: (none) */
#define  PANEL_BAT_CONSTS_LABEL_3         22      /* control type: textMsg, callback function: (none) */
#define  PANEL_LED_BIOLOGIC_STATUS        23      /* control type: LED, callback function: (none) */
#define  PANEL_LED_PSB_STATUS             24      /* control type: LED, callback function: (none) */
#define  PANEL_DEC_STATUS                 25      /* control type: deco, callback function: (none) */
#define  PANEL_CONTROL_LABEL              26      /* control type: textMsg, callback function: (none) */
#define  PANEL_STATUS_LABEL               27      /* control type: textMsg, callback function: (none) */
#define  PANEL_CMD_PROMPT_TEXTBOX         28      /* control type: textBox, callback function: (none) */
#define  PANEL_OUTPUT_TEXTBOX             29      /* control type: textBox, callback function: (none) */
#define  PANEL_EXPERIMENTS                30      /* control type: tab, callback function: (none) */
#define  PANEL_DEC_MANUAL_CONTROL         31      /* control type: deco, callback function: (none) */
#define  PANEL_GRAPH_2                    32      /* control type: graph, callback function: (none) */
#define  PANEL_DEC_GRAPHS                 33      /* control type: deco, callback function: (none) */
#define  PANEL_GRAPH_1                    34      /* control type: graph, callback function: (none) */
#define  PANEL_GRAPH_BIOLOGIC             35      /* control type: graph, callback function: (none) */
#define  PANEL_BAT_CONSTS_LABEL           36      /* control type: textMsg, callback function: (none) */
#define  PANEL_LED_DTB_2_STATUS           37      /* control type: LED, callback function: (none) */
#define  PANEL_LED_DTB_1_STATUS           38      /* control type: LED, callback function: (none) */
#define  PANEL_SPLITTER                   39      /* control type: splitter, callback function: (none) */
#define  PANEL_SPLITTER_3                 40      /* control type: splitter, callback function: (none) */
#define  PANEL_SPLITTER_2                 41      /* control type: splitter, callback function: (none) */
#define  PANEL_STR_DTB_2_STATUS           42      /* control type: string, callback function: (none) */
#define  PANEL_STR_DTB_1_STATUS           43      /* control type: string, callback function: (none) */
#define  PANEL_NUM_DTB_2_SETPOINT         44      /* control type: numeric, callback function: (none) */
#define  PANEL_NUM_ALICAT_SETPOINT        45      /* control type: numeric, callback function: (none) */
#define  PANEL_NUM_DTB_1_SETPOINT         46      /* control type: numeric, callback function: (none) */
#define  PANEL_NUM_DTB_2_TEMPERATURE      47      /* control type: scale, callback function: (none) */
#define  PANEL_NUM_DTB_1_TEMPERATURE      48      /* control type: scale, callback function: (none) */
#define  PANEL_TOGGLE_TEENSY              49      /* control type: binary, callback function: TestTeensyCallback */
#define  PANEL_STR_CMD_PROMPT_INPUT       50      /* control type: string, callback function: CmdPromptInputCallback */
#define  PANEL_NUM_TC0                    51      /* control type: numeric, callback function: (none) */
#define  PANEL_NUM_TC1                    52      /* control type: numeric, callback function: (none) */
#define  PANEL_DEC_TMPCTRL                53      /* control type: deco, callback function: (none) */
#define  PANEL_DEC_BIO_GRAPH              54      /* control type: deco, callback function: (none) */
#define  PANEL_DEC_CMDPROMPT              55      /* control type: deco, callback function: (none) */
#define  PANEL_MASS_FLOW                  56      /* control type: deco, callback function: (none) */
#define  PANEL_DEC_TCS                    57      /* control type: deco, callback function: (none) */
#define  PANEL_MFLOW_DIAL                 58      /* control type: scale, callback function: (none) */
